		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Models",
									"targetURL": "#comacttestprjjson-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comacttestprjjson-display": {
								"semanticObject": "comacttestprjjson",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.act.testprjjson",
									"url": sap.ui.require.toUrl("com/act/testprjjson")
								}
							}
						}
					}
